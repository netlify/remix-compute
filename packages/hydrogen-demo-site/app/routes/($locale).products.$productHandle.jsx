...
import { useLoaderData, Await, useSearchParams, useLocation, useNavigation } from '@remix-run/react'
  ...
  return (
    <div className="grid gap-10">
      <div className="grid gap-4">
        <ProductOptions options={product.options} searchParamsWithDefaults={searchParamsWithDefaults} />
        {selectedVariant && (
          <div className="grid items-stretch gap-4">
            ...
            {!isOutOfStock && (
              <ShopPayButton width="100%" variantIds={[selectedVariant?.id]} storeDomain={storeDomain} />
            )}
          </div>
        )}
      </div>
                      ...
                      <>
                        ...
                        >
                          {option.values.map((value) => (
                            <Listbox.Option key={`option-${option.name}-${value}`} value={value}>
                              {({ active }) => (
                                <ProductOptionLink
...
function ProductOptionLink({ optionName, optionValue, searchParams, children, ...props }) {
        ...
        <>
          <Disclosure.Button className="text-left">
            <div className="flex justify-between">
              ...
              <IconClose
                className={clsx('transition-transform transform-gpu duration-200', !open && 'rotate-[45deg]')}
              />
            </div>
          </Disclosure.Button>
