...
export function CountrySelector() {
  ...
  return (
    <section ref={observerRef} className="grid w-full gap-4" onMouseLeave={closeDropdown}>
...
function getCountryUrlPath({ countryLocale, defaultLocalePrefix, pathWithoutLocale }) {
